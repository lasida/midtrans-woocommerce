(() => {
  ...
  const id = "midtrans_sub_alfamart";
  const name = window.wp.htmlEntities.decodeEntities(
    (0, window.wc.wcSettings.getSetting)("midtrans_sub_alfamart", {}).title
  ) || window.wp.i18n.__("Alfamart Group", "midtrans");

  const desc = (0, window.wc.wcSettings.getSetting)("midtrans_sub_alfamart", {}).description || "";
  const img = (0, window.wc.wcSettings.getSetting)("midtrans_sub_alfamart", {}).icon || "";
