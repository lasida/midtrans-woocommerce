(() => {
  ...
  const id = "midtrans_sub_akulaku";
  const name = window.wp.htmlEntities.decodeEntities(
    (0, window.wc.wcSettings.getSetting)("midtrans_sub_akulaku", {}).title
  ) || window.wp.i18n.__("Akulaku", "midtrans");

  const desc = (0, window.wc.wcSettings.getSetting)("midtrans_sub_akulaku", {}).description || "";
  const img = (0, window.wc.wcSettings.getSetting)("midtrans_sub_akulaku", {}).icon || "";
