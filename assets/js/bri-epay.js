(() => {
  ...
  const id = "midtrans_sub_bri_epay";
  const name = window.wp.htmlEntities.decodeEntities(
    (0, window.wc.wcSettings.getSetting)("midtrans_sub_bri_epay", {}).title
  ) || window.wp.i18n.__("BRImo (e-Pay BRI)", "midtrans");

  const desc = (0, window.wc.wcSettings.getSetting)("midtrans_sub_bri_epay", {}).description || "";
  const img = (0, window.wc.wcSettings.getSetting)("midtrans_sub_bri_epay", {}).icon || "";
