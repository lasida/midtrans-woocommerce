(() => {
  ...
  // Usage specific for Indomaret
  const id = "midtrans_sub_indomaret";
  const name = window.wp.htmlEntities.decodeEntities(
    (0, window.wc.wcSettings.getSetting)("midtrans_sub_indomaret", {}).title
  ) || window.wp.i18n.__("Indomaret", "midtrans");

  const desc = (0, window.wc.wcSettings.getSetting)("midtrans_sub_indomaret", {}).description || "";
  const img = (0, window.wc.wcSettings.getSetting)("midtrans_sub_indomaret", {}).icon || "https://kepri.dompetdhuafa.org/wp-content/uploads/2025/02/indomaret.png";
