(() => {
  ...
  const id = "midtrans_sub_gopay";
  const name = window.wp.htmlEntities.decodeEntities(
    (0, window.wc.wcSettings.getSetting)("midtrans_sub_gopay", {}).title
  ) || window.wp.i18n.__("GoPay", "midtrans");

  const desc = (0, window.wc.wcSettings.getSetting)("midtrans_sub_gopay", {}).description || "";
  const img = (0, window.wc.wcSettings.getSetting)("midtrans_sub_gopay", {}).icon || "https://kepri.dompetdhuafa.org/wp-content/uploads/2025/02/images.png";
