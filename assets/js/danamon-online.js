(() => {
  ...
  const id = "midtrans_sub_danamon_online";
  const name = window.wp.htmlEntities.decodeEntities(
    (0, window.wc.wcSettings.getSetting)("midtrans_sub_danamon_online", {}).title
  ) || window.wp.i18n.__("Danamon Online Banking", "midtrans");

  const desc = (0, window.wc.wcSettings.getSetting)("midtrans_sub_danamon_online", {}).description || "";
  const img = (0, window.wc.wcSettings.getSetting)("midtrans_sub_danamon_online", {}).icon || "";
