(() => {
  ...
  const id = "midtrans_sub_bri_va";
  const name = window.wp.htmlEntities.decodeEntities(
    (0, window.wc.wcSettings.getSetting)("midtrans_sub_bri_va", {}).title
  ) || window.wp.i18n.__("Bank Transfer - BRI VA", "midtrans");

  const desc = (0, window.wc.wcSettings.getSetting)("midtrans_sub_bri_va", {}).description || "";
  const img = (0, window.wc.wcSettings.getSetting)("midtrans_sub_bri_va", {}).icon || "";
