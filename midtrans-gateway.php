...
define('MDTR_VERSION', '2.33');
defined('MDTR_PATH') || define('MDTR_PATH', plugin_dir_path(__FILE__));
defined('MDTR_URL') || define('MDTR_URL', plugin_dir_url(__FILE__));
defined('MDTR_BASENAME') || define('MDTR_BASENAME', plugin_basename(__FILE__));
