...
final class WC_Block_Midtrans_Sub_Permata_VA extends AbstractPaymentMethodType
{
  private $gateway;
  protected $name = 'midtrans_sub_permata_va'; // your payment gateway name

  public function initialize()
  {
    $this->settings = get_option('woocommerce_midtrans_sub_permata_va_settings', []);
    $this->gateway = new WC_Gateway_Midtrans_Sub_Permata_VA();
  }

  public function get_payment_method_script_handles()
  {
    wp_register_script(
      'midtrans-sub-permata-va',
      MDTR_URL . 'assets/js/permata-va.js',
      [
        'wc-blocks-registry',
        'wc-settings',
        'wp-element',
    ...
    if (function_exists('wp_set_script_translations')) {
      wp_set_script_translations('midtrans-sub-permata-va');
    }

    return ['midtrans-sub-permata-va'];
  }
