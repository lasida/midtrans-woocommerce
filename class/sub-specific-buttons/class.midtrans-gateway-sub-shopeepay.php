...
final class WC_Block_Midtrans_Sub_Shopeepay extends AbstractPaymentMethodType
{
    private $gateway;
    protected $name = 'midtrans_sub_shopeepay';// your payment gateway name

    public function initialize()
    {
        $this->settings = get_option('woocommerce_midtrans_sub_shopeepay_settings', []);
        $this->gateway = new WC_Gateway_Midtrans_Sub_Shopeepay();
    }

    public function get_payment_method_script_handles()
    {
        wp_register_script(
            'midtrans-sub-shopeepay',
            MDTR_URL . 'assets/js/shopeepay.js',
            [
                    'wc-blocks-registry',
                    'wc-settings',
                    'wp-element',
        ...
        if (function_exists('wp_set_script_translations')) {
            wp_set_script_translations('midtrans-sub-shopeepay');
        }

        return [ 'midtrans-sub-shopeepay' ];
    }
