...
final class WC_Block_Midtrans_Sub_BCA_Klikpay extends AbstractPaymentMethodType
{
  private $gateway;
  protected $name = 'midtrans_sub_bca_klikpay'; // your payment gateway name

  public function initialize()
  {
    $this->settings = get_option('woocommerce_midtrans_sub_bca_klikpay_settings', []);
    $this->gateway = new WC_Gateway_Midtrans_Sub_BCA_Klikpay();
  }

  public function get_payment_method_script_handles()
  {
    wp_register_script(
      'midtrans-sub-bca-klikpay',
      MDTR_URL . 'assets/js/bca-klikpay.js',
      [
        'wc-blocks-registry',
        'wc-settings',
        'wp-element',
    ...
    if (function_exists('wp_set_script_translations')) {
      wp_set_script_translations('midtrans-sub-bca-klikpay');
    }

    return ['midtrans-sub-bca-klikpay'];
  }
